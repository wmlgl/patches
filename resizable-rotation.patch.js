...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        // Node, CommonJS之类的
        module.exports = factory(require('jquery-ui'));
    } else {
	...
	*/
	...
	var resizableSuper = {
		_mouseStart: $.ui.resizable.prototype._mouseStart,
		_mouseDrag: $.ui.resizable.prototype._mouseDrag,
	};

	$.ui.resizable.prototype._mouseStart = function(event) {
		var angle = getAngle(this.element[0]);
		if(!angle || angel == 0) {
			resizableSuper._mouseStart.call(this, event);
			return;
		}
	...
	$.ui.resizable.prototype._mouseDrag = function(event) {
		...
		var angle = getAngle(this.element[0]);
		if(!angle || angel == 0) {
			resizableSuper._mouseDrag.call(this, event);
			return;
		}
